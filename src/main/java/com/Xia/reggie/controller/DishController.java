...
import com.Xia.reggie.dto.DishDto;
...
import com.Xia.reggie.service.DishFlavorService;
...
//    }
    ...
    public R<List<DishDto>> list(Dish dish){
        ...
        //动态构造key
        String key = "dish_" + dish.getCategoryId() + "_" + dish.getStatus();//dish_1542020631124062210_1
        //先从redis中获取缓存数据
